<?php return array (
  ...
  array (
    ...
    'faker_locale' => 'en_US',
    'cipher' => 'AES-256-CBC',
    'key' => 'base64:HwZeBQiGk3qxPFibgoUwdyfMcI0G6xykoPVcF0XYed4=',
    'previous_keys' => 
    array (
    ),
    'maintenance' => 
  ...
  array (
    ...
    array (
      ...
      array (
        'cluster' => 'redis',
        'prefix' => 'steelflow_mrp_database_',
      ),
      'default' => 
      array (
        'url' => NULL,
  ...
  array (
    ...
    array (
      ...
      array (
        'driver' => 'daily',
        'path' => '/var/www/storage/logs/operations.log',
        'level' => 'info',
        'days' => 14,
        'replace_placeholders' => true,
      ),
