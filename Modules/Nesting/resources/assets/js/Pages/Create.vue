                ...
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg border-t-4 border-weld-500">
                    <div class="p-6 bg-gray-50 border-b border-gray-200">
                        <div class="flex justify-between items-center">
                            <div>
                                <h3 class="text-lg font-bold text-gray-700">Optimizer Configuration</h3>
                                <p class="text-sm text-steel-500">Project: <span class="font-bold text-steel-700">{{ project.job_number }} - {{ project.name }}</span></p>
                            </div>
                    ...
                    <form @submit.prevent="submit" class="p-8">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div>
                                ...
                                <select v-model="form.type" class="block w-full border-steel-300 rounded-md shadow-sm focus:ring-weld-500 focus:border-weld-500 bg-white">
                                    <option value="linear">1D Linear Length (Bars/Beams)</option>
                                    <option value="plate">2D Plate Nesting (Planned)</option>
                                </select>
                        ...
                        <div class="flex items-center justify-between mt-10 pt-6 border-t border-gray-100">
                            <Link :href="route('projects.show', project.id)" class="text-steel-500 hover:text-steel-700 font-medium text-sm">
                                Back to Project
                            </Link>
