        ...
        <div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <div class="relative">
                <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-text-tertiary font-mono">
                  $
                </span>
                <input
                  id="cost_per_unit"
                  ...
                  step="0.01"
                  min="0"
                  class="input-industrial w-full pl-8 font-mono"
                  placeholder="0.00"
                >
              </div>
              <p class="mt-1 text-xs text-text-tertiary">
                Total purchase cost for ONE physical piece
              </p>
            </div>
