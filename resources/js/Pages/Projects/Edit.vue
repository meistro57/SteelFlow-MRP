...
const form = useForm({
    job_number: props.project.job_number,
    name: props.project.name,
    customer_id: props.project.customer_id || '',
    status: props.project.status,
    job_type: props.project.job_type || '',
    po_number: props.project.po_number || '',
    contract_weight_lbs: props.project.contract_weight_lbs || '',
    ship_date: props.project.ship_date || '',
      ...
      <div class="flex items-center justify-between">
        <div class="flex items-center">
          ...
          <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            Edit Project: {{ project.job_number }}
          </h2>
        </div>
        <button
          type="button"
