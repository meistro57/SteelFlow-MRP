  ...
  <AppLayout title="User Management">
    ...
    >
      <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        <div
          class="fixed inset-0 bg-steel-950/80 transition-opacity"
          aria-hidden="true"
          @click="closeModal"
        />
        ...
        <div class="inline-block align-middle bg-steel-900 border border-steel-700 text-left overflow-hidden shadow-2xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
